...
**Nota:** usted puede crear un archivo html corriendo en la consola el siguiente comando: 

rmarkdown::render("CourseSessions/Session1/Session1traducida.Rmd")
...
!["¿Cómo instalar un paquete?"](installpackage.png)
...
!["¿Cómo cargar un paquete instalado? (seleccionandolo)"](loadpackageclick.png)


!["¿Cómo cargar un paquete instalado? (programando)"](loadpackagecommand.png)
