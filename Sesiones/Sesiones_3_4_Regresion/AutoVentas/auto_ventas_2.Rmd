...
print(paste("train set: ",mae_train1))
print(paste("test set: ",mae1))

```

Aunque la mayoría de valores p son cercanos a cero, el modelo incluye algunas variables que no son estadísticamente significativas, por lo cual se debe reducir el número de variables.


### Modelo 2: Eliminación en Reversa
...
model_2<-cv.glmnet(as.matrix(X_train),as.matrix(y_train),
                family="gaussian", alpha = 0, nlambda=20)

#coeficientes
#coef(model_2, s = "lambda.min")
