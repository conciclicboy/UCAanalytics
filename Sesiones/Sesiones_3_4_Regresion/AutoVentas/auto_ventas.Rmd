...
## Camiones
Repitamos el proceso para los camiones
...
### Modelo 3: Reduciendo variables con regularización (...en desarrollo)
Como la diferencia es pequeña, en este caso podemos proceder a regularizar el modelo directamente.

```{r, echo=FALSE, message=FALSE, warning=FALSE}
X_train<-train_set[,c(c("Time","Year", "Q1", "Q2", "Q3"),colnames(b)[10:ncol(b)])]

X_test<-test_set[,c(c("Time","Year", "Q1", "Q2", "Q3"),colnames(b)[10:ncol(b)])]
