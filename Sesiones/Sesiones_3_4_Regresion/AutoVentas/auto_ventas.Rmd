...
**Este caso está basado en el curso de regresión aplicada de Columbia Business School. Puede encontrar la solución original en el archivo [Auto Sales Fall 2017](http://www.columbia.edu/~dj114/8114projects.htm)**
...
Ahora bien, recordemos que en la fase de exploración habíamos seleccionado un conjunto de variables que tenían potencial de ser significativas dada su fuerte correlación con la variable objetivo. Podemos intentar reducir el número de variables manualmente para ver que sucede con el error:
...
## Camiones
Repitamos el proceso para los camiones. Estos son los valores que yo encontré:

### Modelo 1: Datos completos
Usemos todas las variables en todos los períodos
...
Podemos ahora seleccionar en base a los diagramas de dispersión las variables que creamos pueden reduicir el error del modelo aún más.
...
# Sacando predicciones
pred_train_3=predict(model_3, newx = as.matrix(X_train), s = "lambda.min")
pred_test_3=predict(model_3, newx=as.matrix(X_test), s = "lambda.min")
...
>>>>>>> ed4d8c7ef27e2b4e69e245fefb0295cddf019c60
